...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("critical", "high", "medium", "low", "info", "unknown", name="severity"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.Enum("github", "manual", "local", "isolated", name="repositoryprovider"),
            nullable=False,
        ),
        ...
        sa.Column(
            ...
            sa.Enum("public", "private", "restricted", "isolated", name="sourceclassification"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_repositories_provider_repository_id"),
        "repositories",
        ["provider_repository_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_repositories_source_classification"),
        "repositories",
        ["source_classification"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_vulnerabilities_external_id"), "vulnerabilities", ["external_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_applications_repository_id"), "applications", ["repository_id"], unique=False
    )
    op.create_table(
        "jobs",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_technologies_application_id"), "technologies", ["application_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_findings_application_id"), "findings", ["application_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_findings_vulnerability_id"), "findings", ["vulnerability_id"], unique=False
    )
    op.create_table(
        "sboms",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_remediation_actions_action_type"),
        "remediation_actions",
        ["action_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("not_affected", "affected", "fixed", "under_investigation", name="vexstatus"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_vex_statements_finding_id"), "vex_statements", ["finding_id"], unique=False
    )
    op.create_index(
        op.f("ix_vex_statements_review_date"), "vex_statements", ["review_date"], unique=False
    )
